  ...
  return (
    <header className="bg-grey dark:bg-grey">
      ...
      <div className="grid place-items-center">
        <svg className="w-12 h-12 relative bottom-16 hidden lg:block" aria-hidden="true" focusable="false" data-prefix="far" data-icon="arrow-alt-circle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
